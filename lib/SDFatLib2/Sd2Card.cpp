...
#error Sd2Card::init must be updated to use correct DDR/PORT registers
#else
	// set pin modes
	DDRB = 0xB0; // B10110000
#endif	
...
#if !defined(__AVR_ATmega324PA__)
#error chipSelectHigh must be updated to use correct DDR/PORT registers
#else
	PORTB |= 16;	
...
void Sd2Card::chipSelectLow() {
  spiInit(spiRate_);
#if !defined(__AVR_ATmega324PA__)
#error chipSelectLow must be updated to use correct DDR/PORT registers
#else	
	PORTB &= ~16;
