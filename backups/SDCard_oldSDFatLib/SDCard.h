...
Addresses:
 ...
 ; if test returns not equal, the operation completed successfully
...
// controls the maximum folder depth
#define DIR_DEPTH	9
#define DIR_MAX_DEPTH	(DIR_DEPTH-1)
// first entry is for root directory
// fat16 supports at least 16 dirs deep.
